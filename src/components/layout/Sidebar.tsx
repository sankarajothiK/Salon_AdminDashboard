...
export const Sidebar: React.FC<SidebarProps> = ({ collapsed }) => {
  ...
  return (
    <aside
      className={clsx(
        'h-screen bg-white border-r-2 border-emerald-100 flex flex-col transition-all duration-300 z-30 sticky top-0 shadow-sm font-alata select-none',
        collapsed ? 'w-20' : 'w-64'
      )}
    >
      {/* Brand Header */}
      <div className="h-16 px-4 flex items-center gap-3 border-b-2 border-emerald-100 bg-gradient-to-r from-white via-emerald-50/50 to-white">
