  ...
  return (
    <div className="space-y-6 font-alata text-black">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white border-2 border-emerald-100 rounded-2xl p-5 shadow-card-subtle">
          ...
          <div className="text-[11px] text-emerald-900 font-bold mt-1">Aggregated across all salons</div>
        </div>
        ...
        <div className="bg-white border-2 border-emerald-100 rounded-2xl p-5 shadow-card-subtle">
          ...
          <div className="text-[11px] text-emerald-900 font-bold mt-1">{metrics.returningCustomers} repeat clients</div>
        </div>
        ...
        <div className="bg-white border-2 border-emerald-100 rounded-2xl p-5 shadow-card-subtle">
          ...
          <div className="text-[11px] text-emerald-900 font-bold mt-1">100% Operational health</div>
        </div>
        ...
        <div className="bg-white border-2 border-emerald-100 rounded-2xl p-5 shadow-card-subtle">
          ...
          <div className="text-[11px] text-emerald-900 font-bold mt-1">{metrics.todayAppointments} total scheduled</div>
        </div>
      </div>
