...
export const SettingsPage: React.FC = () => {
  ...
  const superAdminPrivileges = [
    ...
    { module: 'Salon Account Deletion Records', description: 'Full access to deleted salon accounts and exit reasons directly from Supabase', status: 'Active' },
  ];
  ...
  return (
    <div className="space-y-6 font-alata text-black">
      ...
      <div className="bg-white border-2 border-emerald-100 rounded-2xl p-6 shadow-card-subtle space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-600 text-white flex items-center justify-center font-bold shadow-emerald-sm">
        ...
        <div className="p-4 bg-emerald-50/70 rounded-xl border border-emerald-200 space-y-2 text-xs text-black font-bold">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-black">salons, customers, appointments, services, staff, bills, bill_items, expenses, account_deletions, notifications</span>
          </div>
          <div className="flex justify-between">
      ...
      <div className="bg-white border-2 border-emerald-100 rounded-2xl overflow-hidden shadow-card-subtle">
        <div className="p-5 border-b-2 border-emerald-100 flex items-center justify-between">
          <div>
          ...
          <span className="px-3 py-1 rounded-full bg-emerald-100 text-emerald-950 border border-emerald-300 text-xs font-bold shadow-2xs flex items-center gap-1.5">
